...
SELECT
    ...
    austria_spread_lag_96qh,
    france_price_lag_96qh,
    france_spread_lag_96qh,
    netherlands_price_lag_96qh,
    netherlands_spread_lag_96qh,
    poland_price_lag_96qh,
    poland_spread_lag_96qh,
    switzerland_price_lag_96qh,
    switzerland_spread_lag_96qh,
    czechia_price_lag_96qh,
    czechia_spread_lag_96qh,
    denmark_1_price_lag_96qh,
    denmark_1_spread_lag_96qh,
    denmark_2_price_lag_96qh,
    denmark_2_spread_lag_96qh,
    ...
    wind_direction_100m_brandenburg_forecast,
    wind_direction_100m_schleswig_forecast,
    wind_direction_100m_bavaria_forecast,
    wind_direction_100m_bawue_forecast,
