...
def save_pipeline(pipeline, model_name: str, metadata: dict | None = None) -> str:
    """
    ...
    copy_source = {"Bucket": bucket, "Key": archive_model_key}
    s3.copy_object(Bucket=bucket, Key=latest_model_key, CopySource=copy_source)
...
def load_pipeline(model_name: str, version: str = "latest"):
    """
